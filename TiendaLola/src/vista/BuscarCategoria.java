...
public class BuscarCategoria extends JPanel {
	...
	private void btnInactivarActionPerformed(ActionEvent evt) {
		try {
			...
			JOptionPane.showMessageDialog(this,categoriaControlador.eliminarCategoria(idCategoria));
			actualizarTabla(modeloTabla,categoriaControlador.listarCategorias());
	...
	private void btnBuscarActionPerformed(ActionEvent evt) {
		try {
			...
			List<Categoria> categorias = categoriaControlador.buscarCategorias(BuscarCategoria.idCategoria,nombre,descripcion);
			if (categorias != null) {

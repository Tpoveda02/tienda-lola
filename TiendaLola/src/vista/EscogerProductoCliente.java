...
public class EscogerProductoCliente extends JPanel {

	//Objeto de la clase Controlador
	private ProductoControlador productoControlador;
	//Objeto de la clase AgregarFacturaCliente
	private AgregarFacturaCliente panelAgregarFactura;
	 ...
	 * Create the panel.
	 */
	public EscogerProductoCliente() {
		productoControlador = new ProductoControlador();
		panelAgregarFactura = new AgregarFacturaCliente();
		listaProductos = new ArrayList<Producto>();
		panelAgregarFactura.detalleProductos = new ArrayList<DetalleFacturaCliente>();
	...
	private void inicializarComponentes() {
		...
		if(panelAgregarFactura.detalleProductos == null) {
			tablaProductosSelec = new JTable(actualizarTablaAgregar(modeloTablaSelec,new ArrayList<DetalleFacturaCliente>()));
		}else {
	 ...
	 */
	private void btnEliminarProductoActionPerformed(ActionEvent evt, List<DetalleFacturaCliente> detalleProductos) {
		try {
	...
	/*
	 * METODO PARA REALIZAR LA ACCIÓN VOLVER AL PANEL DE LA CLASE AgregarFacturaCliente
	 */	
	 ...
	 * METODO PARA ACTUALIZAR LOS REGISTROS DE LA TABLA
	 */
	private DefaultTableModel actualizarTablaAgregar(DefaultTableModel modeloTabla,List<DetalleFacturaCliente> detalleProductos) {
		// Limpiar la tabla
		int rowCount = modeloTabla.getRowCount();
		for (int i = rowCount - 1; i >= 0; i--) {
			modeloTabla.removeRow(i); // eliminar cada fila una por una

...
public class AgregarProveedor extends JPanel {
	...
	private JLabel lblRegistroProveedor;
	...
	private void inicializarComponentes() {
		...
		// Labels
		lblRegistroProveedor = new JLabel("Registro del Proveedor");
		lblRegistroProveedor.setForeground(new Color(135, 134, 133));
		lblRegistroProveedor.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblRegistroProveedor.setBounds(124, 34, 150, 20);
		panelAgregar.add(lblRegistroProveedor);
		...
		panelAgregar.add(lblIdProveedor);

		lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(AgregarProveedor.class.getResource("/media/ImagenPoveedor.png")));
		lblNewLabel.setBounds(626, 120, 200, 200);
		...
		panelAgregar.add(txtIdProveedor);
	...
	private void btnGuardarActionPerformed(ActionEvent evt, JPanel panelAgregar) {
		try {
			...
			if(mensaje.equals("Proveedor creado.")) {

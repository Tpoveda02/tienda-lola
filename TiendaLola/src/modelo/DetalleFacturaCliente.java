...
public class DetalleFacturaCliente {
     ...
     * METODO BUSCAR
     */
    public FacturaCliente buscarPorIdFactura(int idFactura, Connection conexion) {
        ...
        try {
            ...
            facturaCliente.setIdFacturaCliente(idFactura);
            facturaCliente.setProductos(productos);
            conexion.close();
        } catch (SQLException ex) {
